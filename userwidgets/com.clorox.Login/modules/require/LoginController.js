  ...
  return {
      ...
      try{
        ...
        if(isDeviceBiometricSupported && kony.store.getItem('isUserBioMetricEnabled')) {
          ...
          if(type!==undefined && type!==null)
            this.view.tapToLoginText.text = type;
        } else{
    ...
    setDeviceScreen : function(){
      try{
        if(deviceUtil.isTablet()){
          ...
          //#endif
          //#ifdef android
          this.view.btnLogin.width = "55%";
          this.view.tapToLoginSymbol.skin = "sknLblBG0ac7c2";
          this.view.tapToLoginSymbol.width = "40%";
          this.view.tapToLoginSymbol.height = "40%";
          this.view.tapToLoginText.top ="6dp";
          //#endif
          this.view.btnLogin.top = "5%";
    ...
    displayLoginUI : function(){
      try{
        ...
        //#ifdef android
        //#define CHANNEL_android_tabrcandroid
        //#endif
        //#ifdef tabrcandroid
        //#defineCHANNEL_android_tabrcandroid
        //#endif
        //#ifdef CHANNEL_android_tabrcandroid
        this.view.loginOAuth2Browser.handleRequest = this.handleOAuthBrowser.bind(this);
        //#endif

        //#ifdef iphone
        //#define CHANNEL_iphone_ipad
        //#endif
        //#ifdef ipad
        //#define CHANNEL_iphone_ipad
        //#endif
        //#ifdef CHANNEL_iphone_ipad
    ...
    successWrapper: function(response) {
      ...
      try {
        ...
        authorizationClient.getSecurityAttributes(response1=>{
          this.decodeAccessToken({params:response1});
        }, e=>{
   ...
   */
    ...
    refreshToken : function(){
      ...
      authorizationClient.refreshLogin(function(res) {
        ...
        authorizationClient.getSecurityAttributes(response1=>{
          ...
          loginRef.decodeAccessToken({params:response1});
        }, e=>{
      ...
      try {
        ...
        if (status == 5000) {
          ...
          if (deviceType === "faceId")
            this.displayErrorMessage(kony.i18n.getLocalizedString("i18.FaceId.error") + status);
          else
            this.displayErrorMessage(kony.i18n.getLocalizedString("i18n.Touch.error") + status);
        }
        return false;
      } catch (exception) {
        Utils.hideLoadingIndicator();
    ...
    */
    checkAndValidateTouch: function() {
      try {
        //#ifdef winphone8
        this.displayErrorMessage(kony.i18n.getLocalizedString("i18n.TouchWindows.error"));
        return;
        //#endif

        //#ifdef android
        this.androidBiometricPopup();
        //#endif
    ...
    **/
    getBiometryTypeOfDevice : function() {
      try{
        ...
        //#endif
        //#ifdef CHANNEL_android_tabrcandroid
        promptMessage += kony.i18n.getLocalizedString("i18.clorox.LoginBioMetricText");
    ...
    touchAuthenticationCallback: function(status, message) {
      try {
        ...
        if(status == 5000){
          ...
          this.androidBiometricPopup(true);
        } else if(status == 5002){
          this.resetPosition();
        } else if (status == 5003) {
          ...
          this.androidBiometricPopup(true, 5004);
        } else if((status == 5006)){
          this.androidBiometricPopup(true, 5006);
        } else if(status == 5009){
          this.displayErrorMessage(kony.i18n.getLocalizedString("i18n.5009.error"));
        } else if(status == 5011){
          kony.localAuthentication.cancelAuthentication();
          this.androidBiometricPopup(true, 5011);
        }else{
          Utils.hideLoadingIndicator();
   ...
   * @callback touchIDCallback
    ...
    */
    ...
    getDOSHomeData: function(){
      ...
      GlobalServices.getOverview({"query":gblDOSHomeQuery}, DOS.serviceName, DOS.getOverview, null, this.getOverviewDataSuccess, this.getOverviewDataFailure);
      }catch(e){
    ...
    getOverviewDataSuccess : function(response){
      try {
        ...
        if(!Utils.isNullorEmpty(response) && !Utils.isNullorEmpty(response.records[0] ) && 
           !Utils.isNullorEmpty(response.records[0].Common) && !Utils.isNullorEmpty(response.records[0].metric) ){
