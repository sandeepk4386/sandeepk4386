  ...
  return {
    ...
    closePopUp : function(){
      try{
        ...
        if(!Utils.isNullorEmpty(currForm) && !Utils.isNullorEmpty(currForm.flxGenericError)){
          ...
          currForm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.sharing"),
                                            kony.i18n.getLocalizedString("i18.clorox.sharingpopupMsg"),
                                            kony.i18n.getLocalizedString("i18n.clorox.yes"),this.onClickYes,
                                            kony.i18n.getLocalizedString("i18n.clorox.no"),this.onClickNo);
    ...
    invokePostImage: function(base64Val){
      try{
        ...
        var data= {"teamId": gblTeamsId, "channelId": gblTeamChannelId, "base64Val": base64Val, "textVal": textVal};
        var headers= {};
    ...
    postImageSuccess: function(responseContent){
      try{
        ...
        if(responseContent !== null && responseContent !== undefined && responseContent.rawResponse !== null 
           && responseContent.rawResponse !== undefined && responseContent.rawResponse.id !== null 
           && responseContent.rawResponse.id !== undefined){
          Utils.hideLoadingIndicator();  
          if(!Utils.isNullorEmpty(currFrm) && !Utils.isNullorEmpty(currFrm.flxGenericError)){
            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.sharing"),
                                             kony.i18n.getLocalizedString("i18n.clorox.SharePopupSuccess"),
                                             kony.i18n.getLocalizedString("i18.clorox.ok"),Utils.dismissGenericErrorPopup);
    ...
    postImageFailure: function(error){
      try{
        ...
        if(!Utils.isNullorEmpty(currFrm) && !Utils.isNullorEmpty(currFrm.flxGenericError)){
          currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.sharing"),
                                           kony.i18n.getLocalizedString("i18n.clorox.SharePopupFailure"),
                                           kony.i18n.getLocalizedString("i18.clorox.ok"),Utils.dismissGenericErrorPopup);
          currFrm.flxGenericError.setVisibility(true);
        }
        Utils.hideLoadingIndicator();
     ...
     */
        ...
        authClient.login({"userid":gblUserName, "password":gblPwd},
                         function(response) {
