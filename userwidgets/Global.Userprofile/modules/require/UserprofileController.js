        ...
        if(!Utils.isNullorEmpty(currFrm) && currFrm.id === "frmUserProfile" ){
          if(!isDeviceBiometricSupported){
            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.information"),
                                             kony.i18n.getLocalizedString("i18.clorox.BioMetricFinegrPrintText").replace(/Fingerprint/ig,typeID),
          ...
          if(this.view.flxBiometricswtch.skin === "sknToggle0AC7C2OP66"){
            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"),
                                             kony.i18n.getLocalizedString("i18n.clorox.disableBiometric").replace(/Fingerprint/ig,typeID),
            ...
            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"),
                                             kony.i18n.getLocalizedString("i18n.clorox.enableBiometric").replace(/Fingerprint/ig,typeID),
        ...
        if(this.view.flxBiometricswtch.skin === "sknToggle0AC7C2OP66") {
          this.view.flxRoundToggle.animate(
            kony.ui.createAnimation({
              "0":{"left":"20.5dp", "stepConfig":{"timingFunction":kony.anim.LINEAR}},
          ...
          this.view.flxRoundToggle.animate(
            kony.ui.createAnimation({
              ...
              "100": {"left":"20.5dp","stepConfig": {"timingFunction": kony.anim.EASE}}
            }), {
              "delay": 0,
              "iterationCount": 1,
              "fillMode": kony.anim.FILL_MODE_FORWARDS,
      ...
      try{
        ...
        switch (kony.localAuthentication.getBiometryType()) {
          ...
          case constants.BIOMETRY_TYPE_TOUCHID:
            promptMessage += kony.i18n.getLocalizedString("i18n.clorox.touchId");
            break;
          case constants.BIOMETRY_TYPE_FACEID:
            promptMessage += kony.i18n.getLocalizedString("i18n.clorox.faceID");
            break;
    ...
    onClickFeedbackToogle : function(){
      try{  
        ...
        if(this.view.flxFeedbackToggle.skin==="sknToggle0AC7C2OP66"){
          this.view.flxFeedbacktoogleRound.animate(
            kony.ui.createAnimation({
              "0":{"left":"20.5dp", "stepConfig":{"timingFunction":kony.anim.LINEAR}},
              "100": {"left":"7dp","stepConfig": {"timingFunction": kony.anim.EASE}}
            }), {
    ...
    onClickNavGuideToogle : function(){
      try{  
        ...
        if(this.view.flxNavGuideToggle.skin==="sknToggle0AC7C2OP66"){
          this.view.flxNavGuidetoogleRound.animate(
            kony.ui.createAnimation({
              "0":{"left":"20.5dp", "stepConfig":{"timingFunction":kony.anim.LINEAR}},
              "100": {"left":"7dp","stepConfig": {"timingFunction": kony.anim.EASE}}
            }), {
