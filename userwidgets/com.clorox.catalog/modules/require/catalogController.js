      ...
      try{
        if(!Utils.isNullorEmpty(gblGraphData) && !Utils.isNullorEmpty(gblGraphData.data)){
          ...
          if(reloadChart || gblReloadChart){
            ...
            reloadChart = true;
            this.view.linechart.showGridChart();
          }
        } else{
          // empty the chart if there is no data available for chart series.
          this.view.linechart.chartData = {"data": [], "schema": []};
          this.view.linechart.linesData = {"data": [], "schema": []};
          this.view.linechart.showGridChart();
        }
      }catch(e){
