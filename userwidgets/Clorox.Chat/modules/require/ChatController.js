  ...
  return {
    ...
    invokeMSIdentityService: function(){
      try{
        ...
        authClient.login({"userid": gblUserName, "password": gblPwd}, function(response) {
    ...
    invokeGetMessages: function(){
      try{
        ...
        var data= {"teamId": gblTeamsId, "channelId": gblTeamChannelId};
        var headers= {};
    ...
    fetchChat : function(){
      ...
      var data= {"teamId": gblTeamsId, "channelId": gblTeamChannelId, "dateCondition":dateCondition};
      var headers = {};
    ...
    getLast7DaysMessagesSuccess: function(responseContent){
      try{
        ...
        if(!Utils.isNullorEmpty(nextLink) && nextLink.indexOf("$skiptoken") !== -1 && messagesArr.length > 0){
          ...
          var integrationObj = KNYMobileFabric.getIntegrationService(graphChatAPI.serviceName);
          var data= {"teamId": gblTeamsId, "channelId": gblTeamChannelId, "dateCondition": dateCondition, "tokenVal": token};
          var headers= {};
              ...
              if(body.contentType == "text" &&  body.content !== null && body.content != ""){//This means deleted message
                ...
                if(body.content.indexOf("at") !== -1){
                  ...
                  var tempData2 =  { 
                    "name": fromName,
                    "message": text,
                    "img": {"rawBytes":null, "isVisible":true},
                    "date": finalDate,
                    "time": time,
                    "requrl": requrl
                  };
    ...
    getSegData : function(index, chatObj, arrayIndex){
      try{
        ...
        if(arrayIndex === 0 && isLoadMore === false){
          data["flxMainContainer"] = {isVisible:true};
          data["lblLine1"] = {skin : "sknLblFFFFFFBg", text : ""};
          data["lblDate"] = {text : chatDate};
          data["lblLine2"] = {skin : "sknLblFFFFFFBg", text : ""};
          ...
          data["flxMainContainer"] = {isVisible:false}; 
        }
        if(index == 1){
          if(!Utils.isNullorEmpty(chatImage) && !Utils.isNullorEmpty(chatMessage)){
            data["lblName1"] = {text:chatName, isVisible: true};
            data["lblTime1"] = {text:chatTime, isVisible: true};
            data["lblMessage1"] = {isVisible : true,text:chatMessage};
            data["imgChat1"] = {isVisible:true,rawBytes:chatImage};
          }else if(!Utils.isNullorEmpty(chatImage) && Utils.isNullorEmpty(chatMessage)){
            data["lblName1"] = {text:chatName, isVisible: true};
            data["lblTime1"] = {text:chatTime, isVisible: true};
            data["lblMessage1"] = {isVisible:false};
            data["imgChat1"] = {isVisible:true,rawBytes:chatImage};
          }else if(Utils.isNullorEmpty(chatImage) && !Utils.isNullorEmpty(chatMessage)){
            data["lblName1"] = {text:chatName, isVisible: true};
            data["lblTime1"] = {text:chatTime, isVisible: true};
            data["lblMessage1"] = {isVisible:true,text:chatMessage};
            data["imgChat1"] = {isVisible:false};
          }
          data["flxName2"] = {isVisible:false};
          data["lblName2"] = {isVisible: false};
          data["lblTime2"] = {isVisible: false};
          data["lblMessage2"] = {isVisible : false};
          data["imgChat2"] = {isVisible:false};
        }

        if(index == 2){
          if(!Utils.isNullorEmpty(chatImage) && !Utils.isNullorEmpty(chatMessage)){
            data["lblName2"] = {text:chatName, isVisible: true};
            data["lblTime2"] = {text:chatTime, isVisible: true};
            data["lblMessage2"] = {isVisible : true,text:chatMessage};
            data["imgChat2"] = {isVisible:true,rawBytes:chatImage};
          }else if(!Utils.isNullorEmpty(chatImage) && Utils.isNullorEmpty(chatMessage)){
            data["lblName2"] = {text:chatName, isVisible: true};
            data["lblTime2"] = {text:chatTime, isVisible: true};
            data["lblMessage2"] = {isVisible:false};
          ...
          data["flxName1"] = {isVisible:false}; 
          data["lblName1"] = {isVisible: false};
          data["lblTime1"] = {isVisible: false};
          data["lblMessage1"] = {isVisible : false};
          data["imgChat1"] = {isVisible:false};
        }
        return data;
      ...
      try{
        ...
        if(textToSend !== null && textToSend !== undefined && textToSend !== ""){
          ...
          if(textToSend.indexOf("@") !== -1){
            ...
            var data= {"teamId": gblTeamsId,"channelId": gblTeamChannelId,"textVal": textToSend};
            var headers= {};
          ...
          if(!Utils.isNullorEmpty(currFrm) && !Utils.isNullorEmpty(currFrm.flxGenericError)){
            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.chat"),
                                             kony.i18n.getLocalizedString("i18n.clorox.enterText"),
                                             kony.i18n.getLocalizedString("i18.clorox.ok"), this.onClickOk);
      ...
      try{
        ...
        if(! Utils.isNullorEmpty(response) && ! Utils.isNullorEmpty(response.rawResponse) && ! Utils.isNullorEmpty(response.rawResponse.value) ){
          ...
          for(var i=0;i<list.length;i++){
            var tempData = {"userid" : list[i].userId,"lblName" : list[i].displayName,"lblEmailId":list[i].email };
            segData.push(tempData);
          }
        }
    ...
    sendMentionMessage: function(){
      Utils.showLoadingIndicator();
      var integrationObj = KNYMobileFabric.getIntegrationService(graphChatAPI.serviceName);
      var data= {"teamId": gblTeamsId, "channelId": gblTeamChannelId, "mentionText": gblDisplayName, "displayName": gblDisplayName, "userId": gblUserId, "textSent":gblMentionMsg};
      var headers= {};
