     ...
     var getAndRefreshBoundaries = function(geoBoundaryOptions, successCallback, failureCallback, options) {
         ...
         networkProvider.get(url, null, headers, function(res) {
             ...
             if (kony.sdk.getPlatformName() !== kony.sdk.constants.PLATFORM_IOS) {
                 kony.location.setGeofencesCallback(kony.sdk.getCurrentInstance().getMessagingService().manageGeoBoundariesCallback);
             }
 ...
 function konyNetHttpRequest(url, params, headers, httpMethod, konyContentType, successCallback, failureCallback, options) {
     ...
     function localRequestCallback(result) {
         ...
         if (readyState === 4) {
             ...
             if (responseHeaders && responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER) && (kony.sdk.convertPassthroughResponseToJson !== true)) {
     ...
     function helperClassPKCE() {
         ...
         this.appendCodeChallengeOnURL = function(url) {
             if (!kony.sdk.isNullOrUndefined(secureParams) && !kony.sdk.isNullOrUndefined(url)) {
                 url += "&" + kony.sdk.constants.CODE_CHALLENGE + "=" + secureParams[kony.sdk.constants.CODE_CHALLENGE] + "&" + kony.sdk.constants.KEY_CODE_CHALLENGE_METHOD + "=" + kony.sdk.constants.CODE_CHALLENGE_METHOD_VALUE;
