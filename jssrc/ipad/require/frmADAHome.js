define("frmADAHome", function() {
    return function(controller) {
        function addWidgetsfrmADAHome() {
            ...
            this.add(TopBottomNavigation, Feedback, FeedbackPopup, loadingIndicator, flxGenericError);
        };
        return [{
            "addWidgets": addWidgetsfrmADAHome,
