define("com/DOS/DOSBusinessCustomers/userDOSBusinessCustomersController", function() {
    ...
    return {
                            ...
                            for (var s = 0; s < business.length; s++) {
                                ...
                                if (currFrm == "frmDosChart") {
                                    var temp = {
                                        ...
                                        "lblCount": {
                                            text: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? parseInt(metricVal).toLocaleString('en-US') : "",
                                            skin: "sknLblFFFFFSSPR16px100"
                                        },
                                        "flxContainer": {
                                            onClick: dosMainRef.businessChildOnClick.bind(this, business[s].name, business[s].id, s)
                                        }
                                    };
                                    segData.push(temp);
                                } else {
                                    var temp = {
                                        "lblName": business[s].name,
                                        "lblCount": {
                                            text: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? metricFinalVal : "",
                                            skin: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? ((metricFinalVal < 100) ? "sknLblE34547SSPR16px100" : "sknLbl0AC7C2SSPR16px100") : ""
                                        },
                                        "flxContainer": {
                                            onClick: dosMainRef.businessChildOnClick.bind(this, business[s].name, business[s].id, s)
                                        }
                            ...
                            for (var k = 0; k < business.length; k++) {
                                ...
                                if (currFrm == "frmDosChart") {
                                    var temp = {
                                        ...
                                        "lblCount": {
                                            text: (!Utils.isNullorEmpty(metricVal1) && metricVal1 !== "None") ? parseInt(metricVal1).toLocaleString('en-US') : "",
                                            skin: "sknLblFFFFFSSPR16px100"
                                        },
                                        "flxContainer": {
                                            onClick: dosMainRef.businessChildOnClick.bind(this, businessName, business[k].id, k)
                                        }
                                    };
                                    segData1.push(temp);
                                } else {
                                    var temp = {
                                        "lblName": businessName,
                                        "lblCount": {
                                            text: (!Utils.isNullorEmpty(metricVal1) && metricVal1 !== "None") ? metricFinalVal : "",
        ...
        getSegData: function(index, productObj) {
            try {
                ...
                if (currFrm == "frmDosChart") {
                    ...
                    data["flxLeft" + index] = {
                        onClick: dosMainRef.businessOnClick.bind(this, prodName, projId, index)
                    };
                } else {
                    data["lblName" + index] = {
                        text: prodName
                    ...
                    data["lblCount" + index] = {
                        text: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? metricFinalVal.toLocaleString('en-US') : "",
        ...
        getCustomerSegData: function(index, productObj) {
            try {
                ...
                if (currFrm === "frmDosChart") {
                    data["lblName" + index] = {
                        text: productObj.name ? productObj.name : ""
                    };
                    data["lblCount" + index] = {
                        text: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? parseInt(metricVal).toLocaleString('en-US') : "",
                        skin: "sknLblFFFFFSSPR16px100"
                    ...
                    data["flxLeft" + index] = {
                        onClick: dosMainRef.customerOnClickData.bind(this, productObj.name, productObj.id, index)
                    };
                } else {
                    data["lblName" + index] = {
                        text: productObj.name ? productObj.name : ""
                    ...
                    data["lblCount" + index] = {
                        text: (!Utils.isNullorEmpty(metricVal) && metricVal !== "None") ? parseInt(metricVal).toFixed(0).toLocaleString('en-US') : "",
...
define("com/DOS/DOSBusinessCustomers/DOSBusinessCustomersControllerActions", {
    /*
          This is an auto generated file and any modifications to it may result in corruption of the action sequence.
        */
});
define("com/DOS/DOSBusinessCustomers/DOSBusinessCustomersController", ["com/DOS/DOSBusinessCustomers/userDOSBusinessCustomersController", "com/DOS/DOSBusinessCustomers/DOSBusinessCustomersControllerActions"], function() {
    var controller = require("com/DOS/DOSBusinessCustomers/userDOSBusinessCustomersController");
    var actions = require("com/DOS/DOSBusinessCustomers/DOSBusinessCustomersControllerActions");
