define("com/clorox/NotificationSettings/userNotificationSettingsController", function() {
    ...
    return {
        ...
        applyBindings: function() {
            try {
                ...
                if (!Utils.isNullorEmpty(curntForm) && !Utils.isNullorEmpty(curntForm.TopBottomNavigation)) curntForm.TopBottomNavigation.flxTopBar = this.backNav;
            } catch (e) {
        ...
        onAppForeground: function() {
            try {
                ...
                kony.print("inside onAppForeground isNotificationEnable : " + isNotificationEnable + " isPushRegistered : " + isPushRegistered);
        ...
        onPreshow: function() {
            try {
                ...
                var curntForm = kony.application.getCurrentForm();
                if (!Utils.isNullorEmpty(curntForm) && !Utils.isNullorEmpty(curntForm.TopBottomNavigation)) curntForm.TopBottomNavigation.makeTabActive(2);
        ...
        enableDisblePushNotifications: function() {
            try {
                if (!Utils.isNullorEmpty(kony.application.getCurrentForm().loadingIndicator)) kony.application.getCurrentForm().loadingIndicator.isVisible = false;
            ...
            try {
                ...
                for (let i = 0; i < notifRes.length; i++) {
                    var tempRecord = {
                        ...
                        "flxSegToggleMain": {
                            onClick: this.segPushToggleClick.bind(this, i)
                        },
                        "flxSegPushSwtch": {
                            skin: segPushSwitchSkin[i]
                        },
                        "flxRoundToggle": {
                            left: roundToggleProperties[i].left,
                            skin: roundToggleProperties[i].skin
                        }
                    };
            ...
            try {
                if (Utils.isNetworkAvailable()) {
                    ...
                    if (this.view.flxPushSwitch.skin === "sknToggle0AC7C2OP66") {
                        currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.disablePushNotification"), kony.i18n.getLocalizedString("i18n.clorox.disable"), this.onClickEnbaleOrDisable, kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                        ...
                        var emailId = gblPartyEmail;
                        kony.print("inside onClickPushToggle isNotificationEnable : " + isNotificationEnable);
                        if (isNotificationEnable) {
                            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.enablePushNotification"), kony.i18n.getLocalizedString("i18n.clorox.enable"), this.onClickEnbaleOrDisable, kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                            currFrm.flxGenericError.setVisibility(true);
                        } else {
                            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.information"), kony.i18n.getLocalizedString("i18n.clorox.enableDeviceNotifications"), kony.i18n.getLocalizedString("i18n.clorox.ok"), this.onClickCancel);
                            currFrm.flxGenericError.setVisibility(true);
                        }
                    }
                }
        ...
        animationEnd: function() {
            try {
                ...
                if (this.view.flxPushSwitch.skin === "sknToggle0AC7C2OP66") {
                    ...
                    this.mtd_shipments_vs_ndf_exceeds = "unselected";
                    this.mtd_orders_vs_ya_index_exceeds = "unselected";
                    this.view.flxRoundToggleCustNotif.animate(kony.ui.createAnimation({
                        "0": {
                            "left": "20dp",
                            "stepConfig": {
                                "timingFunction": kony.anim.LINEAR
                ...
                if (Utils.isNetworkAvailable()) {
                    if (this.view.flxPushSwitch.skin !== "sknToggleE5E5E5") {
                        ...
                        if (this.view.flxPushSwtchCustNotif.skin === "sknToggle0AC7C2OP66") {
                            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.disableNotification") + this.view.lblNotifSettName.text + "?", kony.i18n.getLocalizedString("i18n.clorox.disable"), this.updateCustomNotifications, kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                            currFrm.flxGenericError.setVisibility(true);
                        } else {
                            currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.enableNotification") + " " + this.view.lblNotifSettName.text + "?", kony.i18n.getLocalizedString("i18n.clorox.enable"), this.updateCustomNotifications, kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                            currFrm.flxGenericError.setVisibility(true);
                        }
                    }
                }
            ...
            try {
                if (this.view.flxPushSwitch.skin !== "sknToggleE5E5E5") {
                    ...
                    if (selectedRow.flxSegPushSwtch.skin === "sknToggle0AC7C2OP66") {
                        currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.disableNotification") + selectedRow.lblNotifSettName + "?", kony.i18n.getLocalizedString("i18n.clorox.disable"), this.updateCloroxNotifications.bind(this, rowIndex), kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                        currFrm.flxGenericError.setVisibility(true);
                    } else {
                        currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.conformation"), kony.i18n.getLocalizedString("i18n.clorox.enableNotification") + selectedRow.lblNotifSettName + "?", kony.i18n.getLocalizedString("i18n.clorox.enable"), this.updateCloroxNotifications.bind(this, rowIndex), kony.i18n.getLocalizedString("i18n.clorox.cancel"), this.onClickCancel);
                        currFrm.flxGenericError.setVisibility(true);
                    }
                }
            } catch (exception) {
...
define("com/clorox/NotificationSettings/NotificationSettingsControllerActions", {
    /*
          This is an auto generated file and any modifications to it may result in corruption of the action sequence.
        */
});
define("com/clorox/NotificationSettings/NotificationSettingsController", ["com/clorox/NotificationSettings/userNotificationSettingsController", "com/clorox/NotificationSettings/NotificationSettingsControllerActions"], function() {
    var controller = require("com/clorox/NotificationSettings/userNotificationSettingsController");
    var actions = require("com/clorox/NotificationSettings/NotificationSettingsControllerActions");
