define("Clorox/AppGuide/userAppGuideController", function() {
...
define("Clorox/AppGuide/AppGuideControllerActions", {
    /*
          This is an auto generated file and any modifications to it may result in corruption of the action sequence.
        */
});
define("Clorox/AppGuide/AppGuideController", ["Clorox/AppGuide/userAppGuideController", "Clorox/AppGuide/AppGuideControllerActions"], function() {
    var controller = require("Clorox/AppGuide/userAppGuideController");
    var actions = require("Clorox/AppGuide/AppGuideControllerActions");
    for (var key in actions) {
        controller[key] = actions[key];
    }
    controller.initializeProperties = function() {
        defineSetter(this, "skin1", function(val) {
            this.view.flxNavGuideAlert.skin = val;
        });
        defineGetter(this, "skin1", function() {
            return this.view.flxNavGuideAlert.skin;
        });
