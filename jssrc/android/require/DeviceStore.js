...
define(function() {
    var DeviceStore = {
        isFirstLogin: function() {
            ...
            if (DeviceStore.isNullorEmpty(loginToken)) return true;
        ...
        isLocaleStored: function() {
            ...
            if (DeviceStore.isNullorEmpty(localeToken)) return false;
            else return true;
        },
        ...
        getLocale: function() {
            ...
            if (DeviceStore.isNullorEmpty(locToken)) return "";
            else return locToken;
        },
        ...
        isTouchSupported: function() {
            ...
            if (DeviceStore.isNullorEmpty(touchIdSuppFlag)) return false;
            else return touchIdSuppFlag;
        },
        ...
        getAllProperties: function() {
            ...
            if (DeviceStore.isNullorEmpty(props)) return "";
            else return props;
        },
        ...
        getVolumePreference: function() {
            ...
            if (DeviceStore.isNullorEmpty(volPref)) return "";
            else return volPref;
        },
        ...
        getZeroVolPreference: function() {
            ...
            if (DeviceStore.isNullorEmpty(zeroVolPref)) return "";
            else return zeroVolPref;
        },
        ...
        getInactivePreference: function() {
            ...
            if (DeviceStore.isNullorEmpty(inactivePref)) return "";
            else return inactivePref;
        },
        ...
        getDontShowAgainFlag: function() {
            ...
            if (DeviceStore.isNullorEmpty(dontShowAgain)) return false;
            else return dontShowAgain;
        },
        ...
        getTouchPreference: function() {
            ...
            if (DeviceStore.isNullorEmpty(pref)) return false;
            else return pref;
        },
