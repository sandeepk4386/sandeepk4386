define("frmNotificationSettings", function() {
    return function(controller) {
        function addWidgetsfrmNotificationSettings() {
            ...
            var NotificationSettings = new com.clorox.NotificationSettings({
                "bottom": "8%",
            ...
            this.add(TopBottomNavigation, NotificationSettings, loadingIndicator, Feedback, FeedbackPopup, flxGenericError);
        };
        return [{
