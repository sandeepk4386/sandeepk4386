define("frmUserProfile", function() {
    return function(controller) {
        function addWidgetsfrmUserProfile() {
            ...
            var Userprofile = new Global.Userprofile({
                "height": "100%",
                "id": "Userprofile",
                "isVisible": true,
                "left": "0dp",
            ...
            this.add(TopBottomNavigation, flxMain, flxGenericError, FeedbackPopup, loadingIndicator);
        };
        return [{
