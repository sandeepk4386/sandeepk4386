define("com/clorox/DOS/userDOSController", function() {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    for (var j in metricsData) {
                        ...
                        if (groupId === AppConstants.GROUPVALUE) { //Common
                            segData.lblGroupName = {
                                text: grpName,
                                skin: groupSkin
                            };
                            segData.lblGroupValue = {
                                text: finalCount
                            };
                            segData.flxGroupMain = {
            ...
            try {
                ...
                for (var s = 0; s < metrics.length; s++) {
                    if (!Utils.isNullorEmpty(metrics[s].color_group)) {
                        if (metrics[s].color_group === AppConstants.COLOR_GROUP_ORDERS) skinVal = "sknLblA7DCECSSPSB16px100";
                        else if (metrics[s].color_group === AppConstants.COLOR_GROUP_SHIPMENTS) skinVal = "sknLblEEB64FSSPSB16px100";
                        else if (metrics[s].color_group === AppConstants.COLOR_GROUP_FORECAST) skinVal = "sknLblC597FFSSPSB16px100";
                    }
                    var value = metrics[s].value;
                    var finalVal = 0;
                    if (!Utils.isNullorEmpty(value)) {
                        finalVal = kony.os.toNumber(value);
                    }
                    var metricVal = (finalVal).toFixed(0);
                    ...
                    if (kpiName == AppConstants.AVG_DAILY_ORDERS_VS_YA_INDEX) {
                        temp = {
                            ...
                            "lblValue": {
                                text: parseInt(metricVal).toLocaleString('en-US'),
                                skin: (metricVal < 100) ? "sknLbl0AC7C2SSPR16px100" : "sknLblE34547SSPR16px100"
                            }
                        };
...
define("com/clorox/DOS/DOSControllerActions", {
    /*
          This is an auto generated file and any modifications to it may result in corruption of the action sequence.
        */
});
define("com/clorox/DOS/DOSController", ["com/clorox/DOS/userDOSController", "com/clorox/DOS/DOSControllerActions"], function() {
    var controller = require("com/clorox/DOS/userDOSController");
    var actions = require("com/clorox/DOS/DOSControllerActions");
