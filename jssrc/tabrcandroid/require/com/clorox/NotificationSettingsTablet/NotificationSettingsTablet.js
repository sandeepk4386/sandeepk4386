define(function() {
    return function(controller) {
        var NotificationSettingsTablet = new kony.ui.FlexContainer(extendConfig({
            ...
            "width": "100%",
            "zIndex": 1
        }, controller.args[0], "NotificationSettingsTablet"), extendConfig({}, controller.args[1], "NotificationSettingsTablet"), extendConfig({}, controller.args[2], "NotificationSettingsTablet"));
        NotificationSettingsTablet.setDefaultUnit(kony.flex.DP);
        ...
        var segNotificationSettings = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segNotificationSettings"), extendConfig({}, controller.args[2], "segNotificationSettings"));
        ...
        NotificationSettingsTablet.add(flxComponentMain);
        return NotificationSettingsTablet;
    }
})