    ...
    return {
        ...
        invokePostShow: function() {
            try {
                ...
                if (currFrmName === "frmDOSHome") {
                    ...
                    if (!gblIsChartBackNav && (prevFrm !== "frmNotifications" || prevFrm !== "frmLogin") && prevFrm !== "frmNotificationSettings" && prevFrm !== "frmUserProfile" && prevFrm !== "frmChatWindow" && prevFrm !== "frmWebURL") {
                        this.view.lblHeader.text = kony.i18n.getLocalizedString("i18.clorox.DOS");
                        this.view.lblHeader.setVisibility(true);
                        this.view.lblInfo.setVisibility(true);
                        ...
                        if (prevFrm === "frmNotifications" || prevFrm === "frmNotificationSettings" || prevFrm === "frmUserProfile" || prevFrm === "frmChatWindow" || prevFrm === "frmWebURL") {
        ...
        makeTabActive: function(tabNumber) {
            try {
                var enableNews = gblAppConfig.UpgradeInfo[AppConstants.ENABLE_NEWS];
                if (tabNumber === 5) {
                    if ((isShareIconEnable === "true" && enableNews === "false") || (isShareIconEnable === "false" && enableNews === "true")) tabNumber = 4;
                    else if (isShareIconEnable === "false" && enableNews === "false") tabNumber = 3;
                } else if (tabNumber === 4) {
                    if (enableNews === "false") tabNumber = 3;
                }
