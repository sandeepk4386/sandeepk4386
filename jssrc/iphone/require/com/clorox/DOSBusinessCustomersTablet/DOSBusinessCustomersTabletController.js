define("com/clorox/DOSBusinessCustomersTablet/userDOSBusinessCustomersTabletController", function() {
        ...
        getSegData: function(index, productObj) {
            try {
                ...
                if (dosMainRef.viewId === "frmDosChart") {
                    data["lblCount" + index] = {
                        text: (!Utils.isNullorEmpty(productObj.metric_value) && productObj.metric_value !== "None") ? parseInt(productObj.metric_value).toFixed(0) : "",
                        skin: "sknLblFFFFFSSPR16px100"
                    };
                } else {
                    data["lblCount" + index] = {
                        text: (!Utils.isNullorEmpty(productObj.metric_value) && productObj.metric_value !== "None") ? parseInt(productObj.metric_value).toFixed(0) : "",
                        skin: !Utils.isNullorEmpty(productObj.metric_value) ? (parseInt(productObj.metric_value).toFixed(0) < 100 ? "sknLblE34547SSPR16px100" : "sknLbl0AC7C2SSPR16px100") : "sknLblE34547SSPR16px100"
                    };
                }
                data["flxLeft" + index] = {
                    onClick: dosMainRef.businessOnClick.bind(this, productObj.name, productObj.id, index)
                };
                return data;
            } catch (e) {
...
define("com/clorox/DOSBusinessCustomersTablet/DOSBusinessCustomersTabletControllerActions", {
    /*
          This is an auto generated file and any modifications to it may result in corruption of the action sequence.
        */
});
define("com/clorox/DOSBusinessCustomersTablet/DOSBusinessCustomersTabletController", ["com/clorox/DOSBusinessCustomersTablet/userDOSBusinessCustomersTabletController", "com/clorox/DOSBusinessCustomersTablet/DOSBusinessCustomersTabletControllerActions"], function() {
    var controller = require("com/clorox/DOSBusinessCustomersTablet/userDOSBusinessCustomersTabletController");
    var actions = require("com/clorox/DOSBusinessCustomersTablet/DOSBusinessCustomersTabletControllerActions");
