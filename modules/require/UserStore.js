...
define(function () {
  ...
  var UserStore = {
    ...
    getTouchPreference : function(){
      ...
      if(UserStore.isNullorEmpty(pref))          	
        return false;
      else
        return pref;
    },
    ...
    getUsername : function(){
      ...
      if(UserStore.isNullorEmpty(username))          	
        return "";
      else
        return username;
    },
    ...
    getPassword : function(){
      ...
      if(UserStore.isNullorEmpty(password))          	
        return "";
      else
        return password;
    },
    ...
    getLoggedInABO : function(){
      ...
      if(UserStore.isNullorEmpty(aboNumber))
        return "";
      else
        return aboNumber;
    },
    ...
    getLoggedInParty : function(){
      ...
      if(UserStore.isNullorEmpty(partyId))
        return "";
      else
        return partyId;
    },
    ...
    getRecentProductDetails : function(){
      ...
      if(UserStore.isNullorEmpty(ProductDetails))          	
        return "";
      else
