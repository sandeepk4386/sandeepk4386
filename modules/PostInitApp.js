...
function sessionErorrPopUp(){
  try{
    ...
    currFrm.GenericError.displayText(kony.i18n.getLocalizedString("i18n.clorox.sessionExpired"),kony.i18n.getLocalizedString("i18n.SessionExpired.error"), 
                                     kony.i18n.getLocalizedString("i18.clorox.ok"),logOutApp);
    if(!currFrm.flxGenericError.parent.isVisible && currFrm.flxGenericError.parent.isVisible!==null){
      ...
      if(!currFrm.flxGenericError.isVisible && currFrm.flxGenericError.isVisible!==null)
        currFrm.flxGenericError.isVisible = true;
    }
